...
class Utils
{
    ...
    public static string $MODERATION_PLAN_STRING = 'Плановая';
    ...
    public static string $MODERATION_PLAN = 'PLAN';


    public static int $ROLE_DRIVER = 3;
    public static int $ROLE_ADVERTISER = 4;
    ...
    public static function moderation_types_string():array{
        return array(
            ...
            'PASTING' => 'Оклейка','PAYMENT'=> 'Выплата','ADMIN' => 'Админстратор', 'PLAN' => 'Плановая'
        );
    }
