...
<div class="sidebar pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="{{route('partner.dashboard')}}" class="nav-item nav-link @if (request()->route()->getName() == 'partner.dashboard') active @endif"> <img style="margin-right: 10px" src="{{asset('images/Activity.svg')}}"> <span>Статистика</span></a>
